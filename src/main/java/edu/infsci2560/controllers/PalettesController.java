...
//delete    
    ...
    public ModelAndView create(@ModelAttribute @Valid LipicPalettes palettte, BindingResult result) {
...
//update
    @RequestMapping(value = "/palettes/like/{id}", method = RequestMethod.PUT)
